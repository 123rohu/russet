...
CREATE TABLE `contactMod` (
  ...
  `typecontact` varchar(250) DEFAULT NULL,
  `age` varchar(250) DEFAULT NULL,
   PRIMARY KEY (`id`)
) ENGINE=InnoDB AUTO_INCREMENT=1 DEFAULT CHARSET=latin1;
INSERT INTO `contactMod` VALUES (1,'Scott','123 Someplace','Anywhere','Ohio','999.999.9999','Scott@test.com','12/25/199','newsletter','10-18');